...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | Ctrl | GUI  |  Alt |=>GAME|ESC/  |Space/|Tab/  |   |Back  |Enter/| Del  |=>SYMB| Alt  | GUI  |  \   |
  ...
  [BASE] = LAYOUT( \
    ...
    KC_LCTRL, KC_LGUI, KC_LALT, TG(GAME), LT(SYMB, KC_ESC), RCTL_T(KC_SPC),SFT_T(KC_TAB), KC_BSPC,    LT(META, KC_ENT), KC_DEL,  TG(SYMB), KC_RALT,  KC_RGUI,  KC_JYEN \
  ),
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | Ctrl | GUI  |  Alt |=>GAME|ESC/  |Space/|Tab/  |   |Back  |Enter/| Del  | Reset| Alt  | GUI  |  \   |
   * |      |      |      |      |~SYMB |RCtrl |Shift |   |Space |~META |      |      |      |      |      |
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [META] = LAYOUT( \
  ...
  [GAME] = LAYOUT( \
    ...
    KC_LALT,  KC_A,    KC_S,    KC_D,    KC_F,   KC_G,   S(KC_8),    S(KC_9),    KC_H,   KC_J,    KC_K,     KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,   S(KC_RBRC), S(KC_BSLS), KC_N,   KC_M,    KC_COMM,  KC_DOT,  KC_SLSH, SFT_T(KC_RO), \
    KC_LCTRL, KC_LGUI, KC_LALT, _______, KC_ESC, KC_SPC, KC_TAB,     KC_BSPC,    KC_ENT, KC_DEL,  _______,  KC_RALT, KC_RGUI, KC_JYEN \
  )
